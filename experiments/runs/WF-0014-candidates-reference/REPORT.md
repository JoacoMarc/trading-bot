# WF-0014 — regime_bh 4h walk-forward IS 24 m / OOS 6 m (fijo)
...
- Reproducibilidad: git bf0f088, params 937532e2f5, datos 95037f50a96a, 0.8 s en MacBook-Air-4.local
...
|---|---|---|---|
| Retorno total | +90.65 % | +175.83 % | +214.53 % |
| CAGR | +17.51 % | +28.87 % | +33.17 % |
| Sharpe (diario) | 1.04 | 0.76 | 1.07 |
| Sortino (diario) | 1.67 | 1.12 | 1.74 |
| Calmar | 1.15 | 0.37 | 1.23 |
| Max drawdown / mayor tramo bajo agua | +15.28 % / 438 d | +77.11 % / 852 d | +26.93 % / 438 d |
| Profit factor | 2.68 | — | — |
| Win rate | +41.18 % | — | — |
