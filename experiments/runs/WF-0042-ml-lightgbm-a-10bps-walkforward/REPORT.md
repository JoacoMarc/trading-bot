# WF-0042 — donchian 4h walk-forward IS 24 m / OOS 6 m (fijo)
...
- Reproducibilidad: git af1b65f, params c8d4a6af5b, datos e61213fad5d5, 55.0 s en MacBook-Air-4.local
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | 2019-08-01 -> 2021-08-01 | 2021-08-01 -> 2022-02-01 | base | -0.02 % | -0.06 | 0.39 % | 3 | 0.91 | 0 | 6 |
...
|---|---|---|---|---|
| Retorno total | -0.02 % | +174.73 % | +203.24 % | +173.86 % |
| CAGR | -0.01 % | +28.74 % | +31.96 % | +28.64 % |
| Sharpe (diario) | -0.02 | 0.76 | 1.04 | 0.72 |
| Sortino (diario) | -0.03 | 1.11 | 1.69 | 1.03 |
| Calmar | -0.01 | 0.37 | 1.16 | 0.35 |
| Max drawdown / mayor tramo bajo agua | +0.39 % / 1361 d | +77.14 % / 852 d | +27.48 % / 438 d | +81.55 % / 1108 d |
| Profit factor | 0.91 | — | — | — |
| Win rate | +33.33 % | — | — | — |
| Expectancy por trade | -0.58 | — | — | — |
| Trades / duración media | 3 / 104.0 h | 0 / — h | 0 / — h | 0 / — h |
| Exposición | +0.54 % | +100.00 % | +100.00 % | +100.00 % |
| Fees pagados / shortfall medio | 2.39 / 10.1 bps | 0.00 / — bps | 0.00 / — bps | 0.00 / — bps |


Rango OOS 2021-08-01 -> 2025-08-01. Equity encadenada 10,000.00 -> 9,997.89 USDT.

Muestra completa con parámetros fijos (2019-08-01 -> 2025-08-01): retorno +0.95 %, Sharpe 0.20, max DD +1.04 %, 15 trades.
...
| Profit factor OOS | >= 1.3 | 0.91 | n/a | ; evidencia ML con cobertura incompleta |
| Max DD OOS | <= 25 % y <= 50 % del DD B&H (77.14 %) | 0.39 % | n/a | ; evidencia ML con cobertura incompleta |
...
| Régimen: retorno 2021 | > 0 | +0.95 % | n/a | muestra completa, parámetros fijos; evidencia ML con cobertura incompleta |
...
| Monte Carlo DD p95 | <= 35 % | 0.40 % | n/a | ; evidencia ML con cobertura incompleta |
...
5,000 corridas sobre 3 trades, semilla 42: max DD p50 +0.20 %, p95 +0.40 %, p99 +0.58 %; retorno p05 -0.40 %, p50 -0.02 %.

Informativo (ADR-0010), bootstrap por bloques de 20 días de los 1460 retornos diarios OOS: max DD p50 +0.32 %, p95 +0.59 %, p99 +0.71 %; retorno p05 -0.32 %, p50 +0.00 %.

## Meseta ±20 %

24 variantes, pasan +58.33 % (PF > 1.1 y retorno > 0). Informativo: +58.33 % de las variantes tiene Sharpe >= 0.5 x el base (0.20). Las 8 peores:

| Cambios | Retorno | PF | Sharpe | Trades | Pasa |
|---|---|---|---|---|---|
| atr_mult=2.4, prediction_threshold=0.55 | -0.56 % | 0.75 | -0.13 | 20 | no |
