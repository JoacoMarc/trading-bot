# WF-0012 — donchian 4h walk-forward IS 24 m / OOS 6 m (fijo)
...
- Reproducibilidad: git bf0f088, params c8d4a6af5b, datos 40a0aa8573b9, 27.8 s en MacBook-Air-4.local
...
- **Veredicto**: no-go
- **Por qué**: El perfil moderado no alcanza el Sharpe OOS mínimo del protocolo (WF-0012 y costos adversos). El beneficio continuo no basta para aprobar. Sin paper ni holdout. En esta corrida fallan: Sharpe OOS = 0.61.
