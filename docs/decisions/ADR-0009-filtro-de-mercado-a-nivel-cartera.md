...
- Nota (2026-09-14, revisión de la Fase 6): el cierre diario pasó a cometerse **al cerrar la vela de las 23:59:59.999 UTC** (antes: con la primera vela del día siguiente), la misma definición que `regime_bh` (ADR-0010), para que el benchmark "B&H BTC filtrado" y la estrategia conmuten en la misma vela. Un día sin esa vela no se comete. Esto adelanta el filtro de `ema_trend` v3 una vela de 4h respecto de WF-0005; la familia está cerrada y la corrida no se repite.
