...
| regime_bh | v1 | confirmada en walk-forward (Gate 1 aprobado salvo holdout, WF-0006; λ final 0.5; ADR-0010). Holdout EXP-0010: DD 6.4 % OK, PF 0.03 FALLA con la pierna larga abierta al corte → `iterar` firmado el 2026-09-14: se cierra el Gate 1 cuando cierre esa posición (regla en la spec) | [`regime-bh-v1.md`](regime-bh-v1.md) |
